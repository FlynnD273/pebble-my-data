...
Pebble.addEventListener('showConfiguration', function() {
  ...
  const blob = new Blob([html_config.replace('_CONFIG_', JSON.stringify(config), 'g')], { type: "text/html" });
  const config_url = URL.createObjectURL(blob);
